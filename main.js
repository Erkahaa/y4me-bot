...
global.reloadHandler = async function (restatConn) {
  ...
  conn.spromote = '@user telah di jadikan admin'
  conn.sdemote = '@user telah diturunkan menjadi member'
  conn.sDesc = 'Deskripsi telag diubah menjadi \n@desc'
  conn.sSubject = 'Nama grup telah diganti menjadi \n@group'
  conn.sIcon = 'Ikon grup telah di ganti'
  conn.sRevoke = 'Link grup telag di setel ulang \n@revoke'
...
global.reload = async (_ev, filename) => {
  if (pluginFilter(filename)) {
    ...
    if (filename in global.plugins) {
      if (existsSync(dir)) conn.logger.info(`🌟 Plugin Ditambahkan - '${filename}'`)
      else {
...
_quickTest()
  .then(() => conn.logger.info('✅ Quick Test has been Done!!'))
  .catch(console.error)